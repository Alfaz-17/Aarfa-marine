...
export default function AdminDashboard() {
  ...
  if (!stats) return <div className="text-xs font-mono font-bold uppercase tracking-widest animate-pulse p-4 text-[#5B9BD5]">Syncing marine system data...</div>;
    ...
    <div className="space-y-12">
      ...
      <div className="flex justify-between items-end border-b border-slate-800 pb-8 relative">
        <div>
          ...
          <p className="text-xs font-mono font-bold text-[#5B9BD5] uppercase tracking-[0.3em] mt-2 m-0">Real-Time Vessel Fleet & Inventory Telemetry</p>
        </div>
        ...
        {cards.map((card, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-[#0A1F40]/50 p-8 border border-[#5B9BD5]/20 group hover:border-[#5B9BD5] transition-all relative overflow-hidden"
            >
              {/* Technical HUD visual style */}
              <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-[#5B9BD5]/40 group-hover:border-[#5B9BD5]" />
              <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-[#5B9BD5]/40 group-hover:border-[#5B9BD5]" />
              <div className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-[#5B9BD5]/40 group-hover:border-[#5B9BD5]" />
              <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-[#5B9BD5]/40 group-hover:border-[#5B9BD5]" />
              
              <CardIcon className="w-8 h-8 text-[#5B9BD5] mb-6 group-hover:scale-110 transition-transform" />
              ...
              <Link href={card.href}>
                 <a className="absolute top-4 right-4 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                    <ArrowUpRight className="w-5 h-5 text-[#5B9BD5]" />
                 </a>
              </Link>
            </motion.div>
          );
      ...
      <div className="grid lg:grid-cols-2 gap-8 mt-12">
        <div className="bg-[#0A1F40]/80 p-10 text-white relative h-64 flex flex-col justify-center border border-[#5B9BD5]/20">
            {/* Corner highlights */}
            ...
            <Link href="/admin/products">
              <a className="inline-flex items-center gap-4 text-[10px] font-mono font-bold uppercase tracking-widest text-[#5B9BD5] hover:text-white transition-all no-underline">
        ...
        <div className="bg-slate-900/60 p-10 border border-slate-800 h-64 flex flex-col justify-center relative">
            ...
            <div className="flex gap-6">
                <Link href="/admin/brands">
                  <a className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#5B9BD5] hover:text-white transition-colors no-underline">
                    Manage Brands
                  </a>
                </Link>
            </div>
